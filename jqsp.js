...
(function ($) {
  ...
  $.widget('glekli.sortablePhotos', {
    ...
    arrange: function () {
      ...
      // ADD 22-07-2020: раскрывалка строк
      if(rowCnt>1){
        var parCont = container.parent( ".prod-box-images" );
        
        parCont.addClass('multiRow _clsd');
        $('.prod-box__title',parCont).attr('data-cntImg',items.length);
        // console.log(items.length);

        parCont.unbind().bind('click',function(){
          $(this).toggleClass('_clsd');
        });
      }
